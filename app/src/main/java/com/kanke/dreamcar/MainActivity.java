...
public class MainActivity extends AppCompatActivity
    ...
    ImageButton chatWithUs;

    ImageButton info;


    FloatingActionButton autotraderLink;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chatWithUs = (ImageButton) findViewById(R.id.chat);

        autotraderLink = (FloatingActionButton) findViewById(R.id.autotraderLink);

        info = (ImageButton) findViewById(R.id.info);

        video = (FloatingActionButton) findViewById(R.id.fab6);
        ...
        autotraderLink.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                Intent intent = new Intent(context, AutoTraderLink.class);
                startActivity(intent);
            }
        });
...
//            @Override
//            public void onClick(View view) {
//                String url = "http://www.autotrader.co.uk/";
...
//            @Override
//            public void onClick(View view) {
//                String url = "https://www.audi.co.uk/";
//                Intent i = new Intent(Intent.ACTION_VIEW);
//                i.setData(Uri.parse(url));
//                startActivity(i);
//            }
